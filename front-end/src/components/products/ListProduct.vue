...
import LatestProductItem from './LatestProductItem.vue';
                        ...
                        <div class="sidebar__item">
                            <div class="latest-product__text">
                                ...
                                <div class="latest-product__slider">
                                    <LatestProductItem :products="products"></LatestProductItem>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="filter__found">
                                    <h6><span>{{ totalElements }}</span> Products found</h6>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        getData(page) {
            axios
                .get(`http://localhost:8080/api/products/list-products?page=${page}`)
                .then(response => {
